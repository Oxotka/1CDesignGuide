...
У флажка заголовок устанавливаем справа
...
Тоже касается и поля Банковский счет. Как правило, по значению уже видно что это за поле. В случае если заголовок не указываем, то обязательно должна быть подсказка ввода.
...
2. Не следует стремится сделать левую и правую часть симметричной. Гораздо важнее чтобы слева были важные поля, а справа неважные.

### Подвал формы

В подвале располагается наименее важная реквизиты. Также там может быть справочная информация в виде итогов.
