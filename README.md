...
4. Чтобы добавить подсказку к значениям переключателя создайте два элемента с путем к одному реквизиту. В этом случае у каждого элемента можно сделать свою подсказку
...
3. Не следует в элементах использовать повторяющиеся слова, лучше вынести их в заголовок
4. Не следует использовать тумблер для 2 значений - не ясно какой пункт выбран
