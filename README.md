...
4. Добавьте кнопку выбора для строковых полей ввода, если это поможет пользователю, например, выбор Пути к файлу или например выбор Наименования
5. Используйте многострочное поле ввода для строковых значений длинее 100 символов. Установите заголовок для многострочного поля заголовок сверху
6. Сохраняйте значения выбранные пользователем для реквизитов формы, если это поможет пользователю, например, поля с периодом или Организация
...
10. Не делайте поле для выбора для одного элемента. В этом случае заполните реквизит самостоятельно, а поле скройте функциональной опцией
